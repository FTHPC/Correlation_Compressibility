...
if (dataset == 'gaussian_type1'){
  ...
  data <- read.csv('generated_data/output_scalarweight_fixed_sum.csv')
  data <- as.data.frame(data)
...
if (dataset == 'gaussian_type2'){
  ...
  data <- read.csv('generated_data/output_spatialweight_fixed_sum.csv')
  data <- as.data.frame(data)
}
...
if (dataset == 'gaussian_type3'){
  ...
  data <- read.csv('generated_data/output_spatialweight_random_sum.csv')
  data <- as.data.frame(data)
}
