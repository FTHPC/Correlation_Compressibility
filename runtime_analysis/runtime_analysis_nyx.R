...
load(file='dataframe_nyx_test_runtime.RData')
...
save(training_bench,file='training_benchmark_runtime_nyx.RData')
...
save(prediction_bench,file='prediction_benchmark_runtime_nyx.RData')
